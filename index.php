...
<main>
	<section class="hero">
		<div class="hero__body">
			...
			<a href="#">
				<span>Ещё не пробовал?</span>
				<p></p>
			</a>
		</div>
		<div class="hero__background">
			<picture>
				<source type="image/webp" data-srcset="<?php echo get_template_directory_uri(); ?>/img/hero__good.webp">
				<source type="image/png" data-srcset="<?php echo get_template_directory_uri(); ?>/img/hero__good.jpg">
				<img src="<?php echo get_template_directory_uri(); ?>/img/hero__good.jpg" alt="New goods">
			</picture>
		</div>
	...
	<section class="snack">
		...
		<div class="swiper">
			<div class="swiper-wrapper">
				<div class="swiper-slide snacks">
					<a href="">
						<img data-src="<?php echo get_template_directory_uri(); ?>/img/cold-snacks/cold-snacks-1.jpg" src="data:image/gif;base64,R0lGODlhIQAXAIAAAP///wAAACH5BAEAAAEALAAAAAAhABcAAAIajI+py+0Po5y02ouz3rz7D4biSJbmiaaqVQAAOw==" alt="cold-snack">
					</a>
					<div class="snacks__body">
						...
						<div class="snacks__buttons">
							...
							<button class="snacks__basket minus" style="display: none;">-</button>
							<button class="snacks__basket plus" style="display: none;">+</button>
						</div>
				...
				<div class="swiper-slide snacks">
					...
					<div class="snacks__body">
						<h3 class="snacks__title">Шашлык</h3>
						<p class="snacks__about">Тоже вкусно</p>
						<div class="snacks__buttons">
							<span class="snacks__price">320</span>
							<button class="snacks__basket basket__default basketDefault">
								<span class="basketDefault">В корзину</span>
								<div class="basket__icon basketDefault">
									<img class="basketDefault" src="<?php echo get_template_directory_uri(); ?>/img/icon/Buy.svg" alt="Buy">
	...
	<section class="about">
		<div class="about-top">
			<div class="about-us">
				<div class="about-us__body">
					...
					<p>
						...
						черте города,
						куда можно сбежать от шумного и пыльного мегаполиса. Мы, действительно уникальные, ведь все
						продумано до
						мелочей: проект построен из дикого закарпатского сруба, камин в основном зале ресторана и
						панорамные окна
						с видом на реку, уютные беседки на берегу реки и лучшая видовая террасса, шатер с посадкой
						на 200 человек,
				...
				<div class="blocks">
						...
						<svg width="70" height="70" viewBox="0 0 70 70" fill="none"
							...
							<g clip-path="url(#clip0_31_13)">
								...
								<path
									...
									fill="white" />
								<path
									d="M48.1502 30.635C41.1515 30.635 35.4577 36.3289 35.4577 43.3276C35.4577 50.3262 41.1515 56.0201 48.1502 56.0201C52.843 56.0201 57.1358 53.4399 59.3532 49.2863C59.6201 48.7866 59.4312 48.1653 58.9315 47.8984C58.4316 47.6315 57.8103 47.8205 57.5436 48.3202C55.6835 51.8045 52.0843 53.9689 48.1502 53.9689C42.2828 53.9689 37.5091 49.1954 37.5091 43.3278C37.5091 37.4602 42.2828 32.6866 48.1502 32.6866C54.0178 32.6866 58.7914 37.4602 58.7914 43.3278C58.7914 43.7019 58.7702 44.0882 58.7285 44.4752C58.6678 45.0384 59.0752 45.5441 59.6384 45.605C60.2013 45.6658 60.7073 45.2583 60.7682 44.6951C60.8177 44.2353 60.8428 43.7753 60.8428 43.3279C60.8427 36.3289 55.1488 30.635 48.1502 30.635V30.635Z"
									fill="white" />
								<path
					...
					<div class="blocks__item">
						<svg width="61" height="61" viewBox="0 0 61 61" fill="red"
							xmlns="http://www.w3.org/2000/svg">
							<g clip-path="url(#clip0_31_25)"></g>
							<path
			...
			<div class="about__background">
				<img data-src="<?php echo get_template_directory_uri(); ?>/img/bg-about-us.jpg" alt="Background-photo" src="<?php echo get_template_directory_uri(); ?>/img/icon/1x1.png">
				<div class="bg-gradient"></div>
			</div>
		</div>
	</section>
	...
	<section class="basket">
		<div class="basket-top">
			<button class="basket-return">
				<div class="basket-return__arrow">
