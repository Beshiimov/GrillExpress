  ...
  const cartInit = () => {
    ...
    addEventListener(`click`, e => {
      ...
      if (target.classList.contains(`plus`)) {
        ...
        const cartItemDOMElement = target.closest(`.product`);
        const productID = cartItemDOMElement.querySelector(`.product__title`).textContent.trim();
        plusQuantity(productID, cartItemDOMElement, target);
      }
      ...
      if (target.classList.contains(`minus`)) {
        ...
        const cartItemDOMElement = target.closest(`.product`);
        const productID = cartItemDOMElement.querySelector(`.product__title`).textContent.trim();
        minusQuantity(productID, cartItemDOMElement, target);
      }
      ...
      if (target.classList.contains(`basketDefault`)) {
        ...
        if (cartItemDOMElement.classList.contains(`snacks`)) {
          hideBasketButton(productID);
          showSnacksQuantity(productID, cartItemDOMElement);
        }
        updateCart();
      }
    })
